document.addEventListener("DOMContentLoaded", () => {
  ...
  // Escape attribute values to safely embed into HTML
                    ...
                    (participant) =>
                      `<li>
                        ...
                        <button
                          ...
                          title="Unregister ${escapeAttr(participant)}"
                          aria-label="Unregister ${escapeAttr(participant)}"
                          data-activity="${escapeAttr(name)}"
                          data-email="${escapeAttr(participant)}"
                        >&times;</button>
                      </li>`
                  )
                  .join("")}
